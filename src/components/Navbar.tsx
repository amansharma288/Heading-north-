    ...
    <>
      <motion.header
        ...
        className={`fixed top-0 inset-x-0 z-50 transition-all duration-700 ${
          scrolled
            ? "bg-[#030305]/70 backdrop-blur-2xl border-b border-white/[0.04]"
            : ""
        }`}
      >
      ...
      <AnimatePresence>
        {mobileOpen && (
          <motion.div
            ...
            className="fixed inset-0 z-[100] bg-[#030305]/98 backdrop-blur-3xl flex flex-col items-center justify-center"
          >
            <button
