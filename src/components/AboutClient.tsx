    ...
    <main>
      <section className="relative h-[70vh] min-h-[550px] flex items-end overflow-hidden">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6 lg:px-10 pb-20 w-full">
          <AnimateIn>
            <span className="text-[#D4A853] text-[11px] uppercase tracking-[0.3em] font-medium">About Us</span>
          </AnimateIn>
          ...
          <div className="grid lg:grid-cols-2 gap-20 items-start">
            ...
            <AnimateIn delay={0.15} y={30}>
              <div className="relative rounded-3xl overflow-hidden aspect-[4/5]">
                ...
                <div className="absolute inset-0 bg-gradient-to-t from-[#08080e]/70 to-transparent" />
              </div>
            </AnimateIn>
          </div>
        </div>
      ...
      <section className="py-28 md:py-36 relative overflow-hidden">
        <div className="absolute inset-0 pointer-events-none">
          <div className="absolute top-1/3 right-0 w-[500px] h-[500px] bg-[#D4A853]/[0.03] rounded-full blur-[150px]" />
        </div>
        <div className="relative z-10 max-w-7xl mx-auto px-6 lg:px-10">
          <div className="max-w-2xl mb-16">
            <AnimateIn>
              <span className="text-[#D4A853] text-[11px] uppercase tracking-[0.3em] font-medium">Our Principles</span>
            </AnimateIn>
            <AnimateIn delay={0.08}>
            ...
            {principles.map((p, i) => (
              <AnimateIn key={p.title} delay={0.04 + i * 0.06} y={24}>
                <div className="p-7 rounded-2xl glass hover:bg-white/[0.06] transition-all duration-700 group h-full">
                  <div className="w-12 h-12 rounded-xl bg-[#D4A853]/10 flex items-center justify-center mb-5 group-hover:bg-[#D4A853]/20 transition-colors duration-700">
                    <p.icon className="text-[#D4A853]" size={22} />
                  </div>
                  <h3 className="text-white font-bold text-lg">{p.title}</h3>
                  <p className="mt-3 text-white/60 text-sm leading-relaxed">{p.desc}</p>
                </div>
              </AnimateIn>
            ))}
          </div>
      ...
      <section className="py-28 md:py-36 relative overflow-hidden">
        <div className="absolute inset-0">
          <Image src={IMAGES.shadow} alt="Dark abstract" fill className="object-cover opacity-[0.06]" sizes="100vw" />
          <div className="absolute inset-0 bg-[#08080e]/95" />
        </div>
        <div className="relative z-10 max-w-4xl mx-auto px-6 lg:px-10">
          <div className="text-center mb-20">
            <AnimateIn>
              <span className="text-[#D4A853] text-[11px] uppercase tracking-[0.3em] font-medium">Our Journey</span>
            </AnimateIn>
            <AnimateIn delay={0.08}>
              <h2 className="mt-5 text-3xl md:text-5xl font-black tracking-tight">
          ...
          <div className="relative">
            <div className="absolute left-5 md:left-1/2 md:-translate-x-1/2 top-0 bottom-0 w-px bg-gradient-to-b from-transparent via-[#D4A853]/30 to-transparent" />
            {timeline.map((item, i) => (
              <AnimateIn key={item.year} delay={0.04 + i * 0.05} x={i % 2 === 0 ? -20 : 20} y={0}>
                <div className={`relative flex items-start mb-12 ml-12 md:ml-0 ${
                  i % 2 === 0 ? "md:flex-row md:pr-[calc(50%+2.5rem)]" : "md:flex-row-reverse md:pl-[calc(50%+2.5rem)]"
                }`}>
                  <div className="absolute left-[-1.75rem] md:left-1/2 md:-translate-x-1/2 w-3 h-3 rounded-full bg-[#D4A853]/70 border-2 border-[#08080e] z-10 top-1" />
                  <div className="glass rounded-xl p-5 flex-1">
                    <span className="text-[#D4A853] font-bold text-lg">{item.year}</span>
                    <h3 className="text-white/90 font-semibold mt-1">{item.title}</h3>
      ...
      <section className="py-28 md:py-36">
        <div className="max-w-7xl mx-auto px-6 lg:px-10">
          <div className="text-center mb-16">
            <AnimateIn>
              <span className="text-[#D4A853] text-[11px] uppercase tracking-[0.3em] font-medium">Leadership</span>
            </AnimateIn>
            <AnimateIn delay={0.08}>
              <h2 className="mt-5 text-3xl md:text-5xl font-black tracking-tight">
              ...
              <AnimateIn key={person.name} delay={0.04 + i * 0.06} y={24}>
                <div className="group">
                  <div className="relative aspect-[3/4] rounded-2xl overflow-hidden mb-4">
                    <Image src={person.img} alt={person.name} fill className="object-cover grayscale group-hover:grayscale-0 transition-all duration-1000" sizes="25vw" />
                    <div className="absolute inset-0 bg-gradient-to-t from-[#08080e]/60 to-transparent" />
                  </div>
      ...
      <section className="relative py-28 overflow-hidden">
        <div className="absolute inset-0">
          <Image src={IMAGES.industrial} alt="Industrial city" fill className="object-cover opacity-[0.08]" sizes="100vw" />
          <div className="absolute inset-0 bg-gradient-to-b from-[#08080e] via-[#08080e]/90 to-[#08080e]" />
        </div>
        <div className="relative z-10 max-w-3xl mx-auto px-6 text-center">
          ...
          <AnimateIn delay={0.1}>
            <p className="mt-5 text-white/60 max-w-md mx-auto">We are always looking for extraordinary people who share our vision.</p>
          </AnimateIn>
          <AnimateIn delay={0.2}>
            <div className="mt-8 flex flex-col sm:flex-row items-center justify-center gap-4">
              <Link href="/careers" className="px-8 py-4 bg-gradient-to-r from-[#D4A853] to-[#9A7B3A] text-[#08080e] font-semibold text-sm rounded-full hover:shadow-2xl hover:shadow-[#D4A853]/20 transition-all duration-700 hover:scale-[1.03] flex items-center gap-2">
                View Open Positions <ArrowUpRight size={16} />
              </Link>
              <Link href="/contact" className="px-8 py-4 border border-white/15 text-white/65 text-sm rounded-full hover:border-[#D4A853]/40 hover:text-[#D4A853] transition-all duration-700">
                Contact Us
              </Link>
            </div>
          </AnimateIn>
